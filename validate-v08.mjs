...
if(version.version!=='0.9.0')errors.push(`Nieprawidłowa wersja: ${version.version}`);
...
console.log(`Kontrola v0.9.0 OK: ${library.length} kart, ${daily.questions.length} pytań, Vite, TypeScript i pojedynczy punkt wejścia.`);
