...
for(const file of ['release.js','cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','v083.js','v091.js','multiplayer-core-v092.js','v092.js','multiplayer-live-core-v093.js','v093.js','v094.js','v097.js','v098.js','v099.js','sw.js']){
...
if(version.version!=='0.9.9')errors.push(`Nieprawidłowa wersja: ${version.version}`);
...
console.log(`Kontrola v0.9.9 OK: ${library.length} kart, ${daily.questions.length} pytań, Vite, TypeScript i pojedynczy punkt wejścia.`);
