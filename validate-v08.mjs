...
if(version.version!=='0.9.4')errors.push(`Nieprawidłowa wersja: ${version.version}`);
...
for(const asset of ['/release.js','/v07.js','/v071.js','/v08.js','/spicy-v081-data.js','/v081.js','/spicy-v082-data.js','/v082.js','/v083.js','/v091.js','/multiplayer-core-v092.js','/v092.js','/multiplayer-live-core-v093.js','/v093.js','/v094.js','/styles.css'])if(!sw.includes(asset))errors.push(`Service worker nie buforuje ${asset}`);
...
console.log(`Kontrola v0.9.4 OK: ${library.length} kart, ${daily.questions.length} pytań, Vite, TypeScript i pojedynczy punkt wejścia.`);
