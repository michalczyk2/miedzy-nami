...
const required=['index.html','release.js','styles.css','release.js','cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','v083.js','manifest.webmanifest','sw.js','vercel.json','version.json','content/library.json','content/daily-match.json','supabase/migrations/001_v07_cloud.sql','002_fix_invite_code.sql'];
const errors=[];
...
for(const file of ['release.js','cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','v083.js','sw.js']){
...
for(const asset of ['styles.css','release.js','cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','v083.js','manifest.webmanifest'])if(!html.includes(`/${asset}`))errors.push(`index.html nie odwołuje się do /${asset}`);
...
if(version.version!=='0.8.3')errors.push(`Nieprawidłowa wersja: ${version.version}`);
...
for(const asset of ['/release.js','/v07.js','/v071.js','/v08.js','/spicy-v081-data.js','/v081.js','/spicy-v082-data.js','/v082.js','/v083.js','/styles.css'])if(!sw.includes(asset))errors.push(`Service worker nie buforuje ${asset}`);
...
console.log(`Kontrola v0.8.3 OK: ${library.length} kart, ${daily.questions.length} pytań, OTP, onboarding i trwała sesja.`);
