...
const required=['index.html','styles.css','cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','manifest.webmanifest','sw.js','vercel.json','version.json','content/library.json','content/daily-match.json','supabase/migrations/001_v07_cloud.sql'];
const errors=[];
...
for(const file of ['cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','sw.js']){
...
for(const asset of ['styles.css','cloud-config.js','app.js','enhancements.js','v05.js','v06.js','v07.js','v071.js','v08.js','spicy-v081-data.js','v081.js','spicy-v082-data.js','v082.js','manifest.webmanifest'])if(!html.includes(`/${asset}`))errors.push(`index.html nie odwołuje się do /${asset}`);
...
if(version.version!=='0.8.2')errors.push(`Nieprawidłowa wersja: ${version.version}`);
...
for(const asset of ['/v07.js','/v071.js','/v08.js','/spicy-v081-data.js','/v081.js','/spicy-v082-data.js','/v082.js','/styles.css'])if(!sw.includes(asset))errors.push(`Service worker nie buforuje ${asset}`);
...
console.log(`Kontrola v0.8.2 OK: ${library.length} kart, ${daily.questions.length} pytań, OTP, onboarding i trwała sesja.`);
