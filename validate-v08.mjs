...
for(const asset of ['/cloud-config.js','/app.js','/enhancements.js','/v05.js','/v06.js','/v07.js','/v071.js','/v08.js','/spicy-v081-data.js','/v081.js','/spicy-v082-data.js','/v082.js','/v083.js'])if(!main.includes(`'${asset}'`))errors.push(`main.ts nie ładuje ${asset}`);
...
if(version.version!=='0.9.1')errors.push(`Nieprawidłowa wersja: ${version.version}`);
...
console.log(`Kontrola v0.9.1 OK: ${library.length} kart, ${daily.questions.length} pytań, Vite, TypeScript i pojedynczy punkt wejścia.`);
