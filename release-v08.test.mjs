...
test('v0.9.6 ładuje aplikację przez jeden moduł TypeScript',()=>{
  const html=read('index.html');
  const main=read('main.ts');
  assert.match(html,/Między Nami 0\.9\.6/);
...
test('v0.9.6 ustawia wersję w buildzie i ładuje cztery tryby multiplayer',()=>{
  const main=read('main.ts');
