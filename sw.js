...
self.addEventListener('fetch',event=>{
  ...
  if(['/cloud-config.js','/version.json','/release.js','/sw.js','/v0913.js','/v0913.css'].includes(url.pathname)){
